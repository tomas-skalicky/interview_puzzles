...
def rearrange_string(s: str) -> str:
    ...
    if total_length <= 1:
        ...
        occurrence_counts_by_letters: Dict[str, int] = dict()
        ...
        list_of_letters_by_occurrence_counts: Dict[int, List[str]] = dict()
        for letter in occurrence_counts_by_letters.keys():
            ...
            if not list_of_letters_by_occurrence_counts.__contains__(occurrence_count):
                list_of_letters_by_occurrence_counts[occurrence_count] = list()
        ...
        if largest_occurrence_count > total_length - largest_occurrence_count + 1:
            ...
            letters_and_occurrence_counts_sorted_desc: List[Tuple[str, int]] = list()
            ...
            lists_to_distribute: List[List[str]] = list()
            last_non_stored_list: List[str] = list()
